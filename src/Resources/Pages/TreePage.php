...
class TreePage extends Page implements HasTree
{
    ...
    protected string $view = 'filament-treeview::pages.tree-page';
    ...
    {
        return static::$breadcrumb ?? __('filament-treeview::tree.breadcrumb');
    }
    ...
    {
        if (method_exists(static::getResource()::getModel(), 'scopeByKeyword')) {  
            return static::getResource()::getEloquentQuery()->when($this->filterValue, function (Builder $query) {
                $query->byKeyword($this->filterValue);
            });     
        }
