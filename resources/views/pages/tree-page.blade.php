<x-filament-panels::page>
    @if ($tree = $this->getTree())
        ...
        @include('filament-treeview::components.tree-filter', [])
        ...
        @if (count($records) > 0)
            ...
            <div class="flex items-center justify-between gap-3 -mb-4">
                ...
                @if ($tree->isCollapsible())
                    ...
                    >
                        ...
                        {{ __('filament-treeview::tree.actions.expand') }}
                    </x-filament::button>
                    <x-filament::button
                        type="button"
                    ...
                    >
                        ...
                        {{ __('filament-treeview::tree.actions.collapse') }}
                    </x-filament::button>
                </div>
                @else
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @if (!$tree->isAutoSave())
                            ...
                            >
                                ...
                                <span class="text-sm">{{ __('filament-treeview::tree.unsaved_changes') }}</span>
                            </div>
                            ...
                            >
                                ...
                                {{ __('filament-treeview::tree.actions.cancel') }}
                            </x-filament::button>
                            ...
                            >
                                ...
                                {{ __('filament-treeview::tree.actions.save') }}
                            </x-filament::button>
                        @endif
                    </div>
                @endif
            ...
            <div class="filament-tree-container">
                @foreach ($records as $record)
                    @include('filament-treeview::components.tree-node', [
                        'record' => $record,
                        'depth' => 0,
    ...
    <script>
        ...
        Livewire.hook('commit', ({ component, respond }) => {
            const filterValue = window.currentTreeInstance.options.livewireComponent.filterValue || '';
            // Before Livewire updates DOM, save current expand/collapse state of all nodes
            const expandedNodes = new Set();
            if (isCollapsible && filterValue === '') {
                        ...
                        if (isCollapsible) {
                            ...
                            document.querySelectorAll('[data-tree-item]').forEach(item => {
                                ...
                                if (childrenContainer && recordId) {
                                    ...
                                    if (filterValue === '') {
                                        shouldBeExpanded = expandedNodes.has(recordId);
        ...
        window.toggleTreeNode = function(button, recordId) {
            ...
            if (childrenContainer) {
                ...
                let filterValue = window.currentTreeInstance.options.livewireComponent.filterValue || '';
                if (filterValue === '') {
